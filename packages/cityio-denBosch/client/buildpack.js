...
IO.buildpacks.denBosch.action = function(){
	...
	var loadShaders = function(){
		...
		//add camera's
		IO.cameraControl.add(9, [51.67285, 5.29323], [51.69203, 5.30217], 2500, 'Overview top').hide(); //Overview top
	    IO.cameraControl.add(0, [51.67285, 5.29323], [51.69203, 5.30217], 500, 'Overview'); //Overview
	    IO.cameraControl.add(1, [51.68877, 5.31707], [51.68873, 5.31170], 80, 'Z-Willemsvaart'); //Z-Willemsvaart.
	    IO.cameraControl.add(2, [51.69088, 5.30097], [51.69402, 5.29868], 220, 'Brugplein'); //Brugplein
	    IO.cameraControl.add(3, [51.72748, 5.30275], [51.72380, 5.30920], 150, 'Maasport'); //Maaspoort
	    IO.cameraControl.add(4, [51.67950, 5.29550], [51.68490, 5.29408], 150, 'Wilhelminaplein'); //Wilhelminapleim
	    IO.cameraControl.add(5, [51.68105, 5.30482], [51.68515, 5.30353], 250, 'Zuidwal'); //Zuidwal
