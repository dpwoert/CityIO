...
buildpack.amsterdam = function(){

	console.log('start fetching Amsterdam');

	//Geo Pos to load
	var lat = 52.371302320540046;
	var lon = 4.898872375488281;
	var radius = 1.5;

	//reset
	mongo.Buildings.remove({ city: 'amsterdam' });
	mongo.Streets.remove({ city: 'amsterdam' });
	mongo.Regions.remove({ city: 'amsterdam' });

	console.log('Resetted mongo');

	//first get all the 2d map data through CitySDK
	var sdk = new SDK('amsterdam');
